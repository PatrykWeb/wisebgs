...
ActiveRecord::Schema.define(version: 2021_12_23_222738) do
  ...
  create_table "sports_facilities_offers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["facility_sports_id"], name: "index_sports_facilities_offers_on_facility_sports_id"
    t.index ["panel_id"], name: "index_sports_facilities_offers_on_panel_id"
  end
  ...
  add_foreign_key "sports_facilities_offers", "facility_sports", column: "facility_sports_id"
  add_foreign_key "sports_facilities_offers", "panels"
end
